<?php
        ...
        //   exit;
        // }
        // $response=file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6LfU8TkUAAAAAJ1B7W0aiSQB3GzWKf2q6onEwWAI".$captcha."&remoteip=".$_SERVER['REMOTE_ADDR']);
        // if($response.success==false)
        // {
        //  	print_r("Jesteś spamerem!");
        // } else {

	$email_to = "dev@pollyart.pl";
	$email_subject = "Kontakt";
	$email_from = "dev@pollyart.pl";
	...
	$email_message .='<tr><td style="font-weight: 600; padding-right: 20px;">Numer telefonu:</td><td>'.$phone.'</td></tr>';
